...
import { ArgTypes } from '@storybook/html-vite';

export const globalTypes: ArgTypes<typeof globalValues> = {
  width: {
    control: {
      type: 'range',
      min: 100,
...
export const rubberBandTypes: ArgTypes<typeof rubberBandValues> = {
  rubberBand: {
    type: 'boolean',
    defaultValue: true,
  },
