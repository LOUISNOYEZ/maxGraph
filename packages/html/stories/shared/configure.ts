...
import { Client, Graph, ImageBox as Image } from '@maxgraph/core';
 ...
 */
export const createGraphContainer = () => {
...
export function configureExpandedAndCollapsedImages(graph: Graph) {
 ...
 */
export function createMainDiv(htmlDescription: string) {
